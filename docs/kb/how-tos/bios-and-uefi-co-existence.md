...
> below cover them; see [[1.6/installation/network-setup/dhcp-server-settings|DHCP Server Settings]] for a
...
[[1.6/installation/network-setup/proxy-dhcp|Proxy DHCP with dnsmasq]]. Otherwise, use one of the other DHCP
