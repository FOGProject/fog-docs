...
During install/update of 1.6 the [[1.6/installation/server/install-fog-server|Installer]] uses a sed command to attempt to update the `/etc/ssh/sshd_config` to have this line
