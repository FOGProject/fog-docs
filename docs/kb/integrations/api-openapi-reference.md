...
[[1.6/kb/integrations/api|API]] for that — and, like the rest of the API, it is unavailable while
...
Paste both exactly as the UI shows them. See [[1.6/kb/integrations/api|API]] for the detail on why.
...
- [[1.6/kb/integrations/api|API]] — authentication, tokens, and worked examples
- [[1.6/kb/integrations/api-expansion-and-pagination|API Pagination, Expansion & Plugin Items]] — paging parameters and
