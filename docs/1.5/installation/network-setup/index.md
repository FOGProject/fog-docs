---
title: Network Setup (1.5)
aliases:
    - Network Setup (1.5)
description: index page for 1.5-specific network setup differences
context_id: network-setup-home-1-5
tags:
    - 1_5-legacy
    - installation
    - network-setup
...
# Network Setup — FOG 1.5 differences
