---
title: Web Management (1.5)
aliases:
    - Web Management (1.5)
description: index page for 1.5-specific web management differences
context_id: web-management-home-1-5
tags:
    - 1_5-legacy
    - management
    - web-management
...
# Web Management — FOG 1.5 differences
...
Everything else in [[management/web/index|the main Web Management section]] — users, tasks, groups, snapins, printers, dashboard, service — applies to 1.5 unchanged.
