...
[[1.6/kb/how-tos/secure-boot-signing|Secure Boot: signing FOS with your own key]]. For
...
| the Secure Boot MOK | **new** — see [[1.6/kb/how-tos/secure-boot-signing\|the Secure Boot guide]], this one needs action |
...
costs, is in [[1.6/kb/reference/netboot-transport-and-pki|Netboot Transport and PKI]].
...
Start at [[1.6/kb/how-tos/secure-boot-signing|Secure Boot: signing FOS with your own key]]
for the concepts and rotating/removing a key; enrollment itself is split
into [[1.6/kb/how-tos/secure-boot-mok-enrollment|MOK enrollment]] (any release) and
...
>see
>[[1.6/kb/how-tos/secure-boot-signing#the-old-flat-mok|the note in the Secure Boot guide]].
