...
aliases:
    - Reference (1.6)
description: index page for 1.6-specific reference differences
context_id: reference-home-1-6
tags:
    - 1_6-changes
    - reference
---

# Reference — FOG 1.6 differences
...
**1.5 equivalents also documented here**
