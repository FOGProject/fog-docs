...
>certificates, see [[1.6/kb/reference/pki-zones|FOG's Certificate Zones]] and
>[[1.6/kb/reference/pki-glossary|the PKI glossary]]. If you're recovering from a much
...
[[1.6/kb/how-tos/secure-boot-mok-enrollment|MOK enrollment]] uses.
...
- **[[1.6/kb/how-tos/secure-boot-mok-enrollment|MOK enrollment]]** — Routes A and B, both
...
>[[1.6/installation/server/migrating-fog-server|Migrating FOG Server]]) is already on your roadmap,
...
>[[1.6/installation/server/migrating-fog-server#migrating-the-secure-boot-signing-material|that guide's Secure Boot section]]
...
[[1.6/kb/reference/secure-boot-technical-details|Secure Boot technical details]] for which to
...
one? See [[1.6/kb/reference/bringing-your-own-ca|Bringing your own CA]] — it covers generating
...
this leaf — see [[1.6/kb/reference/pki-zones#secure-boot|Secure Boot]]. This is the case to
...
**flat model** (see [[1.6/kb/reference/bringing-your-own-ca|Bringing your own CA]]) unless
...
[[1.6/kb/how-tos/secure-boot-mok-enrollment#withdrawing-a-key-from-one-machine|Withdrawing a key from one machine]].
...
- **HTTPS netboot and Secure Boot are independent, and less constrained
  ...
  [[1.6/kb/reference/netboot-transport-and-pki|Netboot Transport and PKI]] for why. With FOG's
...
differently than described in [[1.6/kb/how-tos/secure-boot-mok-enrollment|MOK enrollment]],
...
- [[1.6/kb/reference/secure-boot-technical-details|Secure Boot technical details]] — serving the signed chain, signing kernels, signing your own FOS builds
