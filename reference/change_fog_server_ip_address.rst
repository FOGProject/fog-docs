...
- Update the ipaddress= field (and other fields if necessary) inside the /opt/fog/.fogsettings file. :doc:`More information about the fogsettings file <install_fogsettings>`.
- Rerun the installer
